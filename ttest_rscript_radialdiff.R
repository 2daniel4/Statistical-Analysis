...
#read in xlsx files
diffusion_data = read_excel("diffusion_stats.xlsx", sheet = "RadialDiff_raw")
...
summary(CC_Anterior)
#plot columns
plot(condition,left_hipp, main='Left_hipp_ADC_by_condition')
plot(condition, left_amygdala, main='Left_amygdala_ADC_by_condition')
plot(condition,right_hipp, main="right_hipp_ADC_by_condition")
plot(condition, right_amygdala, main='right_amygdala_ADC_by_condition')
plot(condition, CC_Anterior, main='CC_Anterior_ADC_by_condition')
